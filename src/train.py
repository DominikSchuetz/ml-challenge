...
def main(args):
    ...
    #    Achtung: Report auf train-CV, für echte Bewertung nimm ein Holdout-Set.
    ...
    for fold, (trn_idx, val_idx) in enumerate(cv.split(X, y), 1):
        ...
        pos_idx = list(model.classes_).index(model.classes_[1])  # arbitrary pick 2nd as pos just for auc calc
